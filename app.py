...
class MultiPublishMaster(tank.platform.Application):
    ...
    def init_app(self):
        ...
        tk_multi_publish_master = self.import_module("tk_multi_publish_master")
        
        self._publish_handler = tk_multi_publish_master.PublishHandler(self)
    ...
    def destroy_app(self):
        self.log_debug("Destroying tk-multi-publish-master")
